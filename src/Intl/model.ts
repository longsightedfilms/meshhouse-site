...
export default {
  ...
  "verts": ["Verts:", "Вершин:"],
  "hairFur": {
    "title": ["Hair & fur:", "Система волос/меха:"],
    "none": ["None", "Отсутствует"]
  },
  "morpher": {
    "title": ["Morpher / blendshapes:", "Morpher / blendshapes:"],
    "true": ["Exists", "Присутствует"],
    "false": ["Not exists", "Отсутствует"]
  },
  "skinning": {
    "title": ["Rigging:", "Риггинг / Система костей:"],
    "cat": "Autodesk CAT",
    "bones": {
      "title": ["Bones", "Кости"],
      "system": {
        "custom": ["Custom", "Своя система"],
        "unity": ["Compatible with Unity", "Совместимая с Unity"],
        "ue4": ["Compatible with Unreal Engine 4", "Совместимая с Unreal Engine 4"]
      }
    },
    "none": ["None", "Отсутствует"]
  },
